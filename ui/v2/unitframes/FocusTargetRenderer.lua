...
local function buildStyleTab(inner, barPrefix, applyFn, colorValues, colorOrder)
    ...
    inner:AddBarTextureSelector({
        ...
        get = function() local t = ensureFocusTargetDB() or {}; return t[barPrefix .. "Texture"] or "default" end,
        set = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "Texture"] = v or "default"; applyFn() end end,
    })
    ...
    inner:AddBarTextureSelector({
        ...
        get = function() local t = ensureFocusTargetDB() or {}; return t[barPrefix .. "BackgroundTexture"] or "default" end,
        set = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "BackgroundTexture"] = v or "default"; applyFn() end end,
    })

    inner:AddSelectorColorPicker({
        label = "Background Color",
        values = UF.bgColorValues, order = UF.bgColorOrder,
        get = function() local t = ensureFocusTargetDB() or {}; return t[barPrefix .. "BackgroundColorMode"] or "default" end,
        set = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "BackgroundColorMode"] = v or "default"; applyFn() end end,
...
local function buildBorderTab(inner, barPrefix, applyFn)
    ...
    inner:AddSlider({
        ...
        get = function() local t = ensureFocusTargetDB() or {}; return tonumber(t[barPrefix .. "BorderThickness"]) or 1 end,
        set = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "BorderThickness"] = tonumber(v) or 1; applyFn() end end,
    })
...
function UF.RenderFocusTarget(panel, scrollContent)
    ...
    -- Scale slider (FocusTarget is not in Edit Mode, so we control scale directly)
    builder:AddSlider({
        label = "Scale",
