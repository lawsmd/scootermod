...
local function buildDirectionTab(inner)
    inner:AddSelector({
        ...
        get = function() local t = getUFDB() or {}; return t.healthBarReverseFill and "reverse" or "default" end,
                ...
                buildContent = {
                    sizing = function(cf, tabInner)
                        tabInner:AddSlider({
                            ...
                            get = function() local t = getUFDB() or {}; return tonumber(t.healthBarOverlayHeightPct) or 100 end,
