...
local function buildTextTab(inner, textKey, applyFn, defaultAlignment)
    ...
    inner:AddColorPicker({
        label = "Color",
        get = function() local s = ensureTextDB(textKey) or {}; local c = s.color or {1,1,1,1}; return c[1] or 1, c[2] or 1, c[3] or 1, c[4] or 1 end,
        set = function(r,g,b,a) local t = ensureUFDB(); if t then t[textKey] = t[textKey] or {}; t[textKey].color = {r or 1, g or 1, b or 1, a or 1}; applyStyles() end end,
        hasAlpha = true,
    })
