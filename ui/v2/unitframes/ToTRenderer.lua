...
local function buildSizingTab(inner, barPrefix, applyFn)
    ...
    inner:AddSlider({
        ...
        get = function() local t = ensureToTDB() or {}; return tonumber(t[barPrefix .. "OverlayHeightPct"]) or 100 end,
        set = function(v) local t = ensureToTDB(); if t then t[barPrefix .. "OverlayHeightPct"] = tonumber(v) or 100; applyFn() end end,
    })
